# ISCC Core TS — React Example

A browser-based interactive demo for **iscc-core-ts** built with [React](https://react.dev/) + [Vite](https://vite.dev/) + TypeScript.
...
- [React 19](https://react.dev/) + [Vite 7](https://vite.dev/) + [TypeScript 5.9](https://www.typescriptlang.org/)
...
Each section component lives in `src/components/sections/` and calls the corresponding library function with user-provided inputs, displaying the results in real time.
